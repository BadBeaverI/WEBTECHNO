<?php
$name = "Bobrovskii Sergei";
$prof = "it specialist";
$city = "Rishon LeZion";
$email = "sesmbile1@gmail.com";
$tel = "0502870376";
$skills = [
    [
        'name' => 'Photoshop',
    ...
    [
        'name' => 'Music developer',
        'percent' => 85,
    ],
    [
        'name' => 'DB development or support',
        'percent' => 90,
    ],
     [
        'name' => 'python',
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $expirience [0]["name"]; ?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>from <?php echo $expirience [0]["from"]; ?> to <span
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b> <?php echo $expirience [1]["name"]; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>from  <?php echo $expirience [1]["from"]; ?> to <?php echo $expirience [0]["from"]; ?></h6>
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>from  <?php echo $expirience [2]["from"]; ?> to <?php echo $expirience [1]["from"]; ?></h6>
